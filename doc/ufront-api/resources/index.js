...
function updateTreeState(){
	...
	createCookie("uf-treeState", treeState);
}
...
function setPlatform(platform) {
	createCookie("uf-platform", platform);
...
$(document).ready(function(){
	$("#nav").html(navContent);
	var treeState = readCookie("uf-treeState");
	...
	setPlatform(readCookie("uf-platform") == null ? "all" : readCookie("uf-platform"));
